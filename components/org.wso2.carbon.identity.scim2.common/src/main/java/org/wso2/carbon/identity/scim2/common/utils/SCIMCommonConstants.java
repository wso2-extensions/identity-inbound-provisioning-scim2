...
public class SCIMCommonConstants {
    ...
    public static final String ME_ENDPOINT_NOT_UPDATABLE_CLAIMS = "SCIM2.Me.BlockedClaims.BlockedClaim";
    public static final String ME_ENDPOINT_EXTENDED_NOT_UPDATABLE_CLAIMS =
