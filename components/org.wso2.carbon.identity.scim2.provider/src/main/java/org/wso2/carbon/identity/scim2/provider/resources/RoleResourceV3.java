...
import org.wso2.charon3.core.protocol.endpoints.RoleResourceV3Manager;
...
public class RoleResourceV3 extends AbstractResource {
    ...
    public Response getRole(@PathParam(SCIMConstants.CommonSchemaConstants.ID) String id,
        ...
        try {
            ...
            RoleV3Manager roleManager = IdentitySCIMManager.getInstance().getRoleV3Manager();
            // Create charon-SCIM role endpoint and hand-over the request.
            RoleResourceV3Manager roleResourceManager = new RoleResourceV3Manager();
    ...
    public Response updateUserRole(@PathParam(SCIMConstants.CommonSchemaConstants.ID) String id,
        ...
        try {
            ...
            // Create charon-SCIM role endpoint and hand-over the request.
            RoleResourceV3Manager roleResourceManager = new RoleResourceV3Manager();
            SCIMResponse response = roleResourceManager.updateUsersWithPUTRole(id, resourceString, roleManager);
            return SupportUtils.buildResponse(response);
        } catch (CharonException e) {
            return handleCharonException(e);
        } catch (FormatNotSupportedException e) {
    ...
    public Response patchUserRole(@PathParam(SCIMConstants.CommonSchemaConstants.ID) String id,
        ...
        try {
            ...
            // Create charon-SCIM role endpoint and hand-over the request.
            RoleResourceV3Manager roleResourceManager = new RoleResourceV3Manager();
            SCIMResponse response = roleResourceManager.updateUsersWithPATCHRole(id, resourceString, roleManager);
            return SupportUtils.buildResponse(response);
        } catch (CharonException e) {
            return handleCharonException(e);
        } catch (FormatNotSupportedException e) {
    ...
    public Response updateGroupsRole(@PathParam(SCIMConstants.CommonSchemaConstants.ID) String id,
        ...
        try {
            ...
            // Create charon-SCIM role endpoint and hand-over the request.
            RoleResourceV3Manager roleResourceManager = new RoleResourceV3Manager();
            SCIMResponse response = roleResourceManager.updateGroupsWithPUTRole(id, resourceString, roleManager);
            return SupportUtils.buildResponse(response);
        } catch (CharonException e) {
            return handleCharonException(e);
        } catch (FormatNotSupportedException e) {
    ...
    public Response patchGroupsRole(@PathParam(SCIMConstants.CommonSchemaConstants.ID) String id,
        ...
        try {
            ...
            // Create charon-SCIM role endpoint and hand-over the request.
            RoleResourceV3Manager roleResourceManager = new RoleResourceV3Manager();
            SCIMResponse response = roleResourceManager.updateGroupsWithPATCHRole(id, resourceString, roleManager);
            return SupportUtils.buildResponse(response);
        } catch (CharonException e) {
            return handleCharonException(e);
        } catch (FormatNotSupportedException e) {
