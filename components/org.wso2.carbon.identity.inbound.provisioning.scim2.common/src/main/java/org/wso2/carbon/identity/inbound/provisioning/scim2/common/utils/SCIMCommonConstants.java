...
public class SCIMCommonConstants {
    ...
    public static final String SERVICE_PROVIDER_CONFIG_LOCATION = "http://localhost:9090/scim/v2/ServiceProviderConfig";
    public static final String RESOURCE_TYPE_LOCATION = "http://localhost:9090/scim/v2/ResourceType";
